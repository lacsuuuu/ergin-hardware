    ...
    <>
      <style>
        {`
          ...
          /* Reduced padding and set max-height to ensure it fits without scrolling */
          .invoice-paper { background: white; width: 800px; max-height: 85vh; overflow-y: auto; padding: 25px 40px; border-radius: 8px; box-shadow: 0 10px 30px rgba(0,0,0,0.3); position: relative; color: #333; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
          ...
          /* Compressed vertical margins throughout the document */
          .receipt-header { text-align: center; margin-bottom: 15px; border-bottom: 2px solid #2c3e50; padding-bottom: 15px; }
          .receipt-logo { height: 60px; object-fit: contain; margin-bottom: 5px; }
          ...
          .document-main-title { margin: 15px 0 0 0; font-size: 22px; letter-spacing: 2px; color: #000; font-weight: bold; }
          .receipt-metadata { display: flex; justify-content: space-between; margin-bottom: 15px; font-size: 14px; }
          .receipt-metadata p { margin: 5px 0; }
          .receipt-table { width: 100%; border-collapse: collapse; margin-bottom: 15px; font-size: 14px; }
          .receipt-table th { background: #f1f2f6; padding: 10px 12px; text-align: left; border-bottom: 2px solid #bdc3c7; color: #2c3e50; }
          .receipt-table td { padding: 10px 12px; border-bottom: 1px solid #eee; }
          .receipt-bottom-grid { display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 20px; }
          .legal-text { font-size: 12px; color: #7f8c8d; }
          .valid-claim { font-weight: bold; color: #e74c3c; letter-spacing: 1px; margin-top: 5px; }
          .totals-box { background: #f8f9fa; padding: 12px 20px; border-radius: 6px; border-left: 4px solid #d32f2f; }
          .grand-total { font-size: 18px; font-weight: bold; color: #2c3e50; display: flex; gap: 20px; }
          .signature-section { margin-top: 20px; display: flex; justify-content: flex-end; text-align: center; }
          ...
          .invoice-actions { display: flex; justify-content: flex-end; gap: 15px; margin-top: 15px; border-top: 1px solid #eee; padding-top: 15px; }
      ...
      <div 
        className="invoice-modal-overlay no-print-bg"
        onClick={(e) => {
